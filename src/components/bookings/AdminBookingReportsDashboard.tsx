...
import { ProfessionalReport, getBookingAssignmentReports } from '@/lib/multi-professional-api';
import { MessageSquare, Calendar, User } from 'lucide-react';
import { formatDistanceToNow } from 'date-fns';
import { enUS } from 'date-fns/locale';

interface AdminBookingReportsDashboardProps {
  bookingId: number;
  assignments: Array<{
    id: number;
...
export function AdminBookingReportsDashboard({
  bookingId,
  assignments,
  systemUsers,
  allReports,
  loading,
}: AdminBookingReportsDashboardProps) {
