...
export function DatePicker({
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div
          className="absolute z-50 mt-1.5 bg-white rounded-xl border border-border shadow-xl w-72 overflow-hidden"
          ...
          {yearPickerOpen && (
            <div className="p-3 border-b border-border bg-[#f7f9ff]">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs font-semibold text-[#0E2271]">
