                  ...
                  <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
                    ...
                    <div className="flex gap-4 mt-8">
                      ...
                      <button
                        ...
                        className="flex-[2] py-3 bg-[#F59E0B] text-white rounded-xl text-sm font-black uppercase tracking-widest hover:bg-orange-600 transition-all shadow-lg shadow-orange-500/20"
                      >
                        {loading
                          ? t("auth.processing")
                          : registerStep < 2
