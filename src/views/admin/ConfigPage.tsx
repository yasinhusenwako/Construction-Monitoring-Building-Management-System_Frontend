          ...
          {Object.entries(defaultStatuses).map(([stream, statuses]) => (
            ...
            >
              ...
              <button
                ...
                className="w-full mt-4 py-2 rounded-lg text-white text-sm font-semibold bg-[#1A3580]"
              >
        ...
        <div className="bg-white rounded-xl border border-border shadow-sm overflow-hidden">
          ...
          <div className="px-5 py-3 border-t border-border bg-secondary/30">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg text-white text-sm font-semibold bg-[#1A3580]"
            >
