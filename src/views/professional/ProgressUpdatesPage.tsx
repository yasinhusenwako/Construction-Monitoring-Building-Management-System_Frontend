...
function StatCard({
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white rounded-xl p-5 border border-border shadow-sm hover:shadow-md transition-all text-left w-full group cursor-pointer"
    >
...
export function ProgressUpdatesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <h2 className="text-lg font-bold text-[#0E2271] mt-8 mb-4">
